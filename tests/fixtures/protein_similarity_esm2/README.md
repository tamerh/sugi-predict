...
This directory contains test fixtures for the protein_similarity_esm2 module.
...
- **Generation**: Run `./bioyoda.sh run protein_similarity_esm2 --test` to regenerate
...
cp test_out/raw_data/protein_similarity_esm2/uniprot_test.fasta tests/fixtures/protein_similarity_esm2/test_proteins.fasta
cp test_out/raw_data/protein_similarity_esm2/uniprot_test.fasta.metadata.txt tests/fixtures/protein_similarity_esm2/test_proteins.fasta.metadata.txt
```
...
- `test_out/raw_data/protein_similarity_esm2/uniprot_test.fasta` - Input sequences
- `test_out/raw_data/protein_similarity_esm2/chunks/chunk_*.fasta` - 10 chunk files
- `test_out/data/processed/protein_similarity_esm2/embeddings/chunk_*.h5` - 10 embedding files
- `test_out/data/processed/protein_similarity_esm2/merged/all_embeddings.h5` - Merged file
