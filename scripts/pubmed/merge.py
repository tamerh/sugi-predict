...
config = get_config()
BASE_PROCESSED_DIR = str(config.get_path('PROCESSED_PUBMED_DIR'))
FINAL_OUTPUT_DIR = str(config.get_path('FINAL_PUBMED_DIR'))
MASTER_INDEX_PATH = os.path.join(FINAL_OUTPUT_DIR, 'master_pubmed.index')
MASTER_METADATA_PATH = os.path.join(FINAL_OUTPUT_DIR, 'master_metadata.json')  # Fixed typo
